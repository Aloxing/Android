...
import com.cn.miraclestar.adapter.ListMessageAdapter;
...
public class MainMessageFragment extends Fragment {
    ...
    public static MainMessageFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //获取需要添加的组件
        RecyclerView recyclerView = view.findViewById(R.id.show_list_message);
        ...
        ListMessageAdapter listMessageAdapter = new ListMessageAdapter(getActivity(),list);
